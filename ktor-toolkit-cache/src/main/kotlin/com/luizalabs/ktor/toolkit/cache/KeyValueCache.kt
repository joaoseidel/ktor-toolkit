 ...
 *
 * Implement it over Redis, Memcached or anything else; [InMemoryCache] is provided for single-node
 ...
 *
 * Suitable for a single node. Use a shared store when more than one instance serves the same
 * traffic, otherwise each will hold — and invalidate — its own copy.
 *
